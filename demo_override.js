...
(function () {
  try {
    ...
    const roomsData = [
      {
        ...
        price: 65,
        currency: "USD",
        images: ["img/hotel-1.jpg","img/hotel-1.jpg","img/hotel-1.jpg"]
      },
      {
        id: "DLX",
        name: "Deluxe Ocean",
        ...
        price: 95,
        currency: "USD",
        images: ["img/hotel-2.jpg","img/hotel-2.jpg","img/hotel-2.jpg"]
      },
      {
        id: "SUITE",
        name: "Suite Tropics",
        ...
        price: 140,
        currency: "USD",
        images: ["img/hotel-3.jpg","img/hotel-3.jpg","img/hotel-3.jpg"]
      }
    ];
    ...
    window.fetch = async function(input, init) {
      ...
      if (url.includes("/api/web/rooms") || url.includes("api/web/rooms")) {
        return okJson({ ok: true, rooms: roomsData });
      }
      if (url.includes("/api/web/consulta") || url.includes("api/web/consulta")) {
